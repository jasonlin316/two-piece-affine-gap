...
//       
//       Creation Date:  Wed Jul  1 16:22:04 2020
//       Version: 	r11p2
//
...
`endif
  ...
  reg NOT_A2, NOT_A1, NOT_A0, NOT_D79, NOT_D78, NOT_D77, NOT_D76, NOT_D75, NOT_D74;
  ...
  reg NOT_TA3, NOT_TA2, NOT_TA1, NOT_TA0, NOT_TD79, NOT_TD78, NOT_TD77, NOT_TD76, NOT_TD75;
  reg NOT_TD74, NOT_TD73, NOT_TD72, NOT_TD71, NOT_TD70, NOT_TD69, NOT_TD68, NOT_TD67;
  reg NOT_TD66, NOT_TD65, NOT_TD64, NOT_TD63, NOT_TD62, NOT_TD61, NOT_TD60, NOT_TD59;
  ...
  reg NOT_TD1, NOT_TD0, NOT_RET1N, NOT_STOV;
...
`endif
 ...
 wire  CLK_;
  ...
  buf B265(D_[78], D[78]);
  buf B266(D_[79], D[79]);
  buf B267(EMA_[0], EMA[0]);
  buf B268(EMA_[1], EMA[1]);
  buf B269(EMA_[2], EMA[2]);
  buf B270(EMAW_[0], EMAW[0]);
  buf B271(EMAW_[1], EMAW[1]);
  buf B272(EMAS_, EMAS);
  buf B273(TEN_, TEN);
  buf B274(BEN_, BEN);
  buf B275(TCEN_, TCEN);
  ...
  buf B296(TD_[8], TD[8]);
  buf B297(TD_[9], TD[9]);
  buf B298(TD_[10], TD[10]);
  buf B299(TD_[11], TD[11]);
  buf B300(TD_[12], TD[12]);
  buf B301(TD_[13], TD[13]);
  buf B302(TD_[14], TD[14]);
  buf B303(TD_[15], TD[15]);
  buf B304(TD_[16], TD[16]);
  buf B305(TD_[17], TD[17]);
  buf B306(TD_[18], TD[18]);
  buf B307(TD_[19], TD[19]);
  buf B308(TD_[20], TD[20]);
  buf B309(TD_[21], TD[21]);
  buf B310(TD_[22], TD[22]);
  buf B311(TD_[23], TD[23]);
  buf B312(TD_[24], TD[24]);
  buf B313(TD_[25], TD[25]);
  buf B314(TD_[26], TD[26]);
  buf B315(TD_[27], TD[27]);
  buf B316(TD_[28], TD[28]);
  buf B317(TD_[29], TD[29]);
  buf B318(TD_[30], TD[30]);
  buf B319(TD_[31], TD[31]);
  buf B320(TD_[32], TD[32]);
  buf B321(TD_[33], TD[33]);
  buf B322(TD_[34], TD[34]);
  buf B323(TD_[35], TD[35]);
  buf B324(TD_[36], TD[36]);
  buf B325(TD_[37], TD[37]);
  buf B326(TD_[38], TD[38]);
  buf B327(TD_[39], TD[39]);
  buf B328(TD_[40], TD[40]);
  buf B329(TD_[41], TD[41]);
  buf B330(TD_[42], TD[42]);
  buf B331(TD_[43], TD[43]);
  buf B332(TD_[44], TD[44]);
  buf B333(TD_[45], TD[45]);
  buf B334(TD_[46], TD[46]);
  buf B335(TD_[47], TD[47]);
  buf B336(TD_[48], TD[48]);
  buf B337(TD_[49], TD[49]);
  buf B338(TD_[50], TD[50]);
  buf B339(TD_[51], TD[51]);
  buf B340(TD_[52], TD[52]);
  buf B341(TD_[53], TD[53]);
  buf B342(TD_[54], TD[54]);
  buf B343(TD_[55], TD[55]);
  buf B344(TD_[56], TD[56]);
  buf B345(TD_[57], TD[57]);
  buf B346(TD_[58], TD[58]);
  buf B347(TD_[59], TD[59]);
  buf B348(TD_[60], TD[60]);
  buf B349(TD_[61], TD[61]);
  buf B350(TD_[62], TD[62]);
  buf B351(TD_[63], TD[63]);
  buf B352(TD_[64], TD[64]);
  buf B353(TD_[65], TD[65]);
  buf B354(TD_[66], TD[66]);
  buf B355(TD_[67], TD[67]);
  buf B356(TD_[68], TD[68]);
  buf B357(TD_[69], TD[69]);
  buf B358(TD_[70], TD[70]);
  buf B359(TD_[71], TD[71]);
  buf B360(TD_[72], TD[72]);
  buf B361(TD_[73], TD[73]);
  buf B362(TD_[74], TD[74]);
  buf B363(TD_[75], TD[75]);
  buf B364(TD_[76], TD[76]);
  buf B365(TD_[77], TD[77]);
  buf B366(TD_[78], TD[78]);
  buf B367(TD_[79], TD[79]);
  buf B368(TQ_[0], TQ[0]);
  buf B369(TQ_[1], TQ[1]);
  buf B370(TQ_[2], TQ[2]);
  buf B371(TQ_[3], TQ[3]);
  ...
  buf B376(TQ_[8], TQ[8]);
  buf B377(TQ_[9], TQ[9]);
  buf B378(TQ_[10], TQ[10]);
  buf B379(TQ_[11], TQ[11]);
  buf B380(TQ_[12], TQ[12]);
  buf B381(TQ_[13], TQ[13]);
  buf B382(TQ_[14], TQ[14]);
  buf B383(TQ_[15], TQ[15]);
  buf B384(TQ_[16], TQ[16]);
  buf B385(TQ_[17], TQ[17]);
  buf B386(TQ_[18], TQ[18]);
  buf B387(TQ_[19], TQ[19]);
  buf B388(TQ_[20], TQ[20]);
  buf B389(TQ_[21], TQ[21]);
  buf B390(TQ_[22], TQ[22]);
  buf B391(TQ_[23], TQ[23]);
  buf B392(TQ_[24], TQ[24]);
  buf B393(TQ_[25], TQ[25]);
  buf B394(TQ_[26], TQ[26]);
  buf B395(TQ_[27], TQ[27]);
  buf B396(TQ_[28], TQ[28]);
  buf B397(TQ_[29], TQ[29]);
  buf B398(TQ_[30], TQ[30]);
  buf B399(TQ_[31], TQ[31]);
  buf B400(TQ_[32], TQ[32]);
  buf B401(TQ_[33], TQ[33]);
  buf B402(TQ_[34], TQ[34]);
  buf B403(TQ_[35], TQ[35]);
  buf B404(TQ_[36], TQ[36]);
  buf B405(TQ_[37], TQ[37]);
  buf B406(TQ_[38], TQ[38]);
  buf B407(TQ_[39], TQ[39]);
  buf B408(TQ_[40], TQ[40]);
  buf B409(TQ_[41], TQ[41]);
  buf B410(TQ_[42], TQ[42]);
  buf B411(TQ_[43], TQ[43]);
  buf B412(TQ_[44], TQ[44]);
  buf B413(TQ_[45], TQ[45]);
  buf B414(TQ_[46], TQ[46]);
  buf B415(TQ_[47], TQ[47]);
  buf B416(TQ_[48], TQ[48]);
  buf B417(TQ_[49], TQ[49]);
  buf B418(TQ_[50], TQ[50]);
  buf B419(TQ_[51], TQ[51]);
  buf B420(TQ_[52], TQ[52]);
  buf B421(TQ_[53], TQ[53]);
  buf B422(TQ_[54], TQ[54]);
  buf B423(TQ_[55], TQ[55]);
  buf B424(TQ_[56], TQ[56]);
  buf B425(TQ_[57], TQ[57]);
  buf B426(TQ_[58], TQ[58]);
  buf B427(TQ_[59], TQ[59]);
  buf B428(TQ_[60], TQ[60]);
  buf B429(TQ_[61], TQ[61]);
  buf B430(TQ_[62], TQ[62]);
  buf B431(TQ_[63], TQ[63]);
  buf B432(TQ_[64], TQ[64]);
  buf B433(TQ_[65], TQ[65]);
  buf B434(TQ_[66], TQ[66]);
  buf B435(TQ_[67], TQ[67]);
  buf B436(TQ_[68], TQ[68]);
  buf B437(TQ_[69], TQ[69]);
  buf B438(TQ_[70], TQ[70]);
  buf B439(TQ_[71], TQ[71]);
  buf B440(TQ_[72], TQ[72]);
  buf B441(TQ_[73], TQ[73]);
  buf B442(TQ_[74], TQ[74]);
  buf B443(TQ_[75], TQ[75]);
  buf B444(TQ_[76], TQ[76]);
  buf B445(TQ_[77], TQ[77]);
  buf B446(TQ_[78], TQ[78]);
  buf B447(TQ_[79], TQ[79]);
  buf B448(RET1N_, RET1N);
  buf B449(STOV_, STOV);
